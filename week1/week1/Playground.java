...
public class Playground {
    ...
    // create an array list called selections of integers for the selections the
    // user will enter

    // ----make a int method to get the selection from the user called
    // getSelection()---
    ...
    // This part might be hard but know you can cast a variable with (int) and then
    // a second statment
    ...
    // create a boolean method called calcPanel that takes in the following
    // parameters:
    // 1. 2d int array ladder
    // 2. Integer ArrayList called selections

    // This method is pretty complex and will calculate the selections from the user
    // in getSelection
    ...
    // create an int variable called currentSelection to get the current selection
    // from the getSelection method
    // use the array list's add method to add the currentSelection
    // create an int choice to use the selections array list method .get for the
    // selections size-1(also another arraylist method)
    ...
    // else
    // remove the last variable from the selections arraylist (using size method
    // (size-1) like above)
    // increment the round counter
    ...
    // From here you will need to create 2 more methods one for printLadder() and
    // one for printCurrentLadder()
    // printLadder():
    ...
    // printCurrentLadder():
    // print System.out.println("|||||| ---- Start");
    // make a nested for loop like above except the i should be i <
    // selections.size()
